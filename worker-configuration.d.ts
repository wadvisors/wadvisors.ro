/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f7827190267642485e60c88f09012974)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		SECRET: "change-me";
		GIT_BRANCH: "no-branch" | "$WORKERS_CI_BRANCH";
		GIT_SHA: "0000000" | "$WORKERS_CI_COMMIT_SHA";
		API_TOKEN: "";
		BUCKET: R2Bucket;
		DB: D1Database;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SECRET" | "GIT_BRANCH" | "GIT_SHA" | "API_TOKEN">> {}
}
