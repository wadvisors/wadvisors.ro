/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7e811ca0dd432abb9e15dab792365585)
// Runtime types generated with workerd@1.20251001.0 2025-08-15 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		WORKERS_CI_BRANCH: "no-branch" | "$WORKERS_CI_BRANCH";
		WORKERS_CI_COMMIT_SHA: "0000000" | "$WORKERS_CI_COMMIT_SHA";
		SECRET: string;
		API_TOKEN: string;
		RESEND_TOKEN: string;
		BUCKET: R2Bucket;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "WORKERS_CI_BRANCH" | "WORKERS_CI_COMMIT_SHA" | "SECRET" | "API_TOKEN" | "RESEND_TOKEN">> {}
}
